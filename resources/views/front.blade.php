...
<head>
    ...
    <title>Kesatria Keyboard - Coding Expert in web and mobile development</title>
...
<body class="presentation-page loading">
    ...
    <div class="wrapper">
        <div class="page-header section-dark" style="background-image: url('{{ url('img/antoine-barres.jpg') }}')">
    		...
    		<!--h6 class="category category-absolute">Designed and coded by
    			<a href="https://www.creative-tim.com" target="_blank">
    				<img src="{{ url('img/creative-tim-white-slim2.png') }}" class="creative-tim-logo">
    			</a>
    		</h6-->
    	</div>
        <div class="main">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="card-image">
                                            <img class="img" src="{{ url('img/blog1.jpg') }}" />
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                                        <div class="card-body">
            ...
            <div class="section-white contactus">
