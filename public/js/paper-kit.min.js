...
examples={initContactUsMap:function(){var myLatlng=new google.maps.LatLng(-8.1276157,112.6798475);var myCenter=new google.maps.LatLng(-8.1276157,112.6748475);var mapOptions={zoom:16,center:myCenter,scrollwheel:false,}
var map=new google.maps.Map(document.getElementById("contactUsMap"),mapOptions);var marker=new google.maps.Marker({position:myLatlng,title:"Kestria Keyboard Office"});marker.setMap(map);}}
